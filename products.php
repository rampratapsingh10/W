    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <div class="row text-center" id="shirts">
                ...
                <div class="row text-center" id="Jackets">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/s1.jpeg" alt="" height=150px width=150px>
                        <div class="caption">
                            <h3>MANTLCONX</h3>
                            <p>Price Rs. 800.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
              ...
              <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/s2.jpeg" alt="" height=150px width=150px>
                        <div class="caption">
                            <h3>Langbeeyar</h3>
                            <p>Price Rs. 1300.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/s3.jpeg" alt="" height=140px width=140px>
                        <div class="caption">
                            <h3>Leather</h3>
              ...
              <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/s4.jpeg" alt="" height=150px width=150px>
                        <div class="caption">
                            <h3>KOSMO MASA</h3>
                            <p>Price Rs. 3000.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m1.jpeg" alt="" height=180px width=180px>
                        <div class="caption">
                            <h3>One Plus</h3>
                            <p>Price Rs. 25,000.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
               ...
               <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m2.jpeg" alt="" height=100px width=100px>
                        <div class="caption">
                            <h3>Nokia 3.4</h3>
                            <p>Price Rs. 13,690.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
               ...
               <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m3.jpeg" alt="" height=130px width=130px>
                        <div class="caption">
                            <h3>Oppo A53</h3>
                            <p>Price Rs. 12,900.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m4.jpeg" alt="" height=130px width=130px>
                        <div class="caption">
                            <h3>oppo A52</h3>
                            <p>Price Rs. 13,990.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
